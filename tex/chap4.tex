...
\begin{figure}[!t]
    ...
    \begin{tikzpicture}[scale=1, every node/.style={scale=1},anchor=south west]%, every node/.style={scale=1},anchor=south west]
        \begin{axis}[xlabel={Horizontal shift $[\si{\milli\meter}]$},ylabel={RF-RF efficiency $[\%]$},
                legend style={
                        at={(axis cs:97,0.7)},
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{The PET over different horizntal shift.}
\end{figure}
...
\begin{figure}[!t]
    \centering
    \begin{tikzpicture}[scale=1, every node/.style={scale=1},anchor=south west]%, every node/.style={scale=1},anchor=south west]
        \begin{axis}[xlabel={Vertical shift $[\si{\milli\meter}]$},ylabel={RF-RF efficiency $[\%]$},
                legend style={
                        at={(axis cs:24.5,0.5)},
                        legend cell align={left},
                        legend columns=1,
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{The PET over different vertical shift.}
\end{figure}
